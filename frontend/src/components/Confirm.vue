...
<template>
  <div
    id="popup-modal"
    tabindex="-1"
    class="h-modal fixed top-0 right-0 left-0 z-50 flex h-full items-center justify-center overflow-y-auto overflow-x-hidden bg-neutral-900/50 md:inset-0"
    v-if="show"
  >
      ...
      <div class="relative rounded-lg bg-white shadow dark:bg-gray-600">
        ...
        <div class="p-6 text-center">
          ...
          <button
            ...
            data-modal-toggle="popup-modal"
            type="button"
            class="rounded-lg border border-gray-200 bg-white px-5 py-2.5 text-sm font-medium text-gray-600 hover:bg-gray-100 hover:text-gray-900 focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:border-gray-600 dark:bg-gray-600 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white dark:focus:ring-gray-600"
          >
            No, cancel
          </button>
        </div>
